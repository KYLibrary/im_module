...
- (void)_setupViews
{
    ...
    [backButton setImage:[UIImage imageNamed:@"close_white" bundleName:@"Account.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    self.scanView.animationImage = [UIImage imageNamed:@"scanLine" bundleName:@"Account.bundle" inBundleForClass:[self class]];
//    __weak typeof(self) weakself = self;
