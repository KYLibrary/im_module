...
- (void)_setupSubviews
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"navbar_white" bundleName:@"Account.bundle" inBundleForClass:[self class]] forBarMetrics:UIBarMetricsDefault];
    [self.navigationController.navigationBar.layer setMasksToBounds:YES];
    self.view.backgroundColor = [UIColor whiteColor];
    
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"device_disable" bundleName:@"Account.bundle" inBundleForClass:[self class]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(devicesAction)];
    self.navigationItem.leftBarButtonItem.enabled = NO;
    
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"qr" bundleName:@"Account.bundle" inBundleForClass:[self class]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(qrCodeAction)];
...
//    self.pswdField.clearButtonMode = UITextFieldViewModeWhileEditing;
    ...
    [self.pswdRightView setImage:[UIImage imageNamed:@"secure" bundleName:@"Account.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    [self.pswdRightView setImage:[UIImage imageNamed:@"unsecure" bundleName:@"Account.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
