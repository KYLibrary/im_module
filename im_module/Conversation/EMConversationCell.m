...
- (void)setModel:(EMConversationModel *)model
{
    ...
    if (conversation.type == EMConversationTypeChat) {
        self.avatarView.image = [UIImage imageNamed:@"user_avatar_blue" bundleName:@"Helper.bundle" inBundleForClass:[self class]];
    } else {
        self.avatarView.image = [UIImage imageNamed:@"group_avatar" bundleName:@"Helper.bundle" inBundleForClass:[self class]];
    }
