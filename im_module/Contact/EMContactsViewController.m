...
- (void)_setupSubviews
{
    ...
    self.notifCell.avatarView.image = [UIImage imageNamed:@"notification" bundleName:@"Contact.bundle" inBundleForClass:[self class]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == 0) {
        if (row == 0) {
            cell.avatarView.image = [UIImage imageNamed:@"contact" bundleName:@"Contact.bundle" inBundleForClass:[self class]];
            cell.nameLabel.text = @"添加好友";
        } else if (row == 2) {
            cell.avatarView.image = [UIImage imageNamed:@"group" bundleName:@"Contact.bundle" inBundleForClass:[self class]];
            cell.nameLabel.text = @"群组";
        } else if (row == 3) {
            cell.avatarView.image = [UIImage imageNamed:@"chatroom" bundleName:@"Contact.bundle" inBundleForClass:[self class]];
            cell.nameLabel.text = @"聊天室";
        } else if (row == 4) {
            cell.avatarView.image = [UIImage imageNamed:@"call" bundleName:@"Contact.bundle" inBundleForClass:[self class]];
