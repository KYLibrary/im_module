...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.tableView && indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            cell.avatarView.image = [UIImage imageNamed:@"group_create" bundleName:@"Group.bundle" inBundleForClass:[self class]];
            cell.nameLabel.text = @"创建群组";
        } else if (indexPath.row == 1) {
            cell.avatarView.image = [UIImage imageNamed:@"group_join" bundleName:@"Group.bundle" inBundleForClass:[self class]];
    ...
    cell.avatarView.image = [UIImage imageNamed:@"group_avatar" bundleName:@"Group.bundle" inBundleForClass:[self class]];
