...
- (void)_setupSubviews
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"navbar_white" bundleName:@"Group.bundle" inBundleForClass:[self class]] forBarMetrics:UIBarMetricsDefault];
    [self.navigationController.navigationBar.layer setMasksToBounds:YES];
    
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"close_gray" bundleName:@"Group.bundle" inBundleForClass:[self class]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(closeAction)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        checkButton.tag = 100;
        [checkButton setImage:[UIImage imageNamed:@"uncheck" bundleName:@"Group.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
        [checkButton setImage:[UIImage imageNamed:@"checked" bundleName:@"Group.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
    ...
    cell.avatarView.image = [UIImage imageNamed:@"user_avatar_blue" bundleName:@"Helper.bundle" inBundleForClass:[self class]];
