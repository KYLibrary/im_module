...
- (void)_setupViewsWithType:(EMMessageType)aType
{
    ...
    if (self.direction == EMMessageDirectionSend) {
        _avatarView.image = [UIImage imageNamed:@"user_avatar_me" bundleName:@"Helper.bundle" inBundleForClass:[self class]];
        ...
        _avatarView.image = [UIImage imageNamed:@"user_avatar_blue" bundleName:@"Helper.bundle" inBundleForClass:[self class]];
        [_avatarView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.contentView).offset(15);
