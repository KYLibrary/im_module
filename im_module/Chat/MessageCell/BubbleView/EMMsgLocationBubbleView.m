                             ...
                             type:(EMMessageType)aType
{
    ...
    if (self) {
        if (self.direction == EMMessageDirectionSend) {
            self.iconView.image = [UIImage imageNamed:@"msg_location_white" bundleName:@"Chat.bundle" inBundleForClass:[self class]];
        } else {
            self.iconView.image = [UIImage imageNamed:@"msg_location" bundleName:@"Chat.bundle" inBundleForClass:[self class]];
        }
    }
