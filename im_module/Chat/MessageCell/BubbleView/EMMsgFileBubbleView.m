...
- (void)_setupSubviews
{
    ...
    if (self.direction == EMMessageDirectionSend) {
        self.iconView.image = [UIImage imageNamed:@"msg_file_white" bundleName:@"Chat.bundle" inBundleForClass:[self class]];
        ...
        self.iconView.image = [UIImage imageNamed:@"msg_file" bundleName:@"Chat.bundle" inBundleForClass:[self class]];
        [self.iconView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self).offset(10);
