...
- (void)_setupSubviews
{
    ...
    [self.recordButton setBackgroundImage:[UIImage imageNamed:@"chat_audio_blue" bundleName:@"Chat.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
...
- (void)recordButtonTouchCancelBegin
{
    ...
    [self.recordButton setBackgroundImage:[UIImage imageNamed:@"chat_audio_red" bundleName:@"Chat.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
}
