...
- (NSArray *)_formatMessages:(NSArray<EMMessage *> *)aMessages
{
    ...
    for (int i = 0; i < [aMessages count]; i++) {
        ...
        EMReadReceiptMemberModel *model = [[EMReadReceiptMemberModel alloc]initWithInfo:[UIImage imageNamed:@"user_avatar_me"  bundleName:@"Helper.bundle" inBundleForClass:[self class]] nick:msg.from time:timeStr];
...
- (void)_setupSubviews
{
    ...
    [self.closeButton setImage:[UIImage imageNamed:@"back_gary" bundleName:@"Chat.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
...
- (void)_readReceiptDetil {
    ...
    img.image = [UIImage imageNamed:@"pin-red" bundleName:@"Chat.bundle" inBundleForClass:[self class]];
