...
{
    if (self.conversationModel.emModel.type == EMConversationTypeChat) {
        UIImage *image = [[UIImage imageNamed:@"chat_clear" bundleName:@"Chat.bundle" inBundleForClass:[self class]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        ...
        UIImage *image = [[UIImage imageNamed:@"chat_info" bundleName:@"Chat.bundle" inBundleForClass:[self class]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
