...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        checkButton.tag = 100;
        [checkButton setImage:[UIImage imageNamed:@"uncheck" bundleName:@"Chat.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
        [checkButton setImage:[UIImage imageNamed:@"checked" bundleName:@"Chat.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
