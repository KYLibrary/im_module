...
- (void)enableSearchController
{
    ...
    if (self.searchButton == nil) {
        ...
        [self.searchButton setImage:[UIImage imageNamed:@"search_gray" bundleName:@"Helper.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    if (self.resultNavigationController == nil) {
        ...
        [self.resultNavigationController.navigationBar setBackgroundImage:[[UIImage imageNamed:@"navBarBg" bundleName:@"Helper.bundle" inBundleForClass:[self class]] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forBarMetrics:UIBarMetricsDefault];
    }
}
