...
+ (instancetype)getGifGroup
{
    ...
    gGifGroup = [[EMEmoticonGroup alloc] initWithType:EMEmotionTypeGif dataArray:models2 icon:[UIImage imageNamed:tagImgName  bundleName:@"Helper.bundle" inBundleForClass:[self class]] rowCount:2 colCount:4];
    return gGifGroup;
}
