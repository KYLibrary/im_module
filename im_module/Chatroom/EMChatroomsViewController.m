...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.tableView && indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            cell.avatarView.image = [UIImage imageNamed:@"chatroom_create" bundleName:@"Chatroom.bundle" inBundleForClass:[self class]];
    ...
    cell.avatarView.image = [UIImage imageNamed:@"chatroom_avatar" bundleName:@"Chatroom.bundle" inBundleForClass:[self class]];
