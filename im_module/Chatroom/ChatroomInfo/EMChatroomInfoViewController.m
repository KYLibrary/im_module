...
- (void)_setupSubviews
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"" bundleName:@"Chatroom.bundle" inBundleForClass:[self class]] style:UIBarButtonItemStylePlain target:self action:@selector(chatroomAnnouncementAction)];
    self.title = @"聊天室信息";
