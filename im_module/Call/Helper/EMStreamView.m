...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.bgView.image = [UIImage imageNamed:@"bg_connecting" bundleName:@"Call.bundle" inBundleForClass:[self class]];
...
- (void)setStatus:(StreamStatus)status
{
    ...
    switch (_status) {
        ...
        {
            if (_enableVoice) {
                _statusView.image = [UIImage imageNamed:@"ring_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]];
            }
        }
            break;
        case StreamStatusConnected:
        {
            ...
            if (!self.isLockedBgView) {
                _bgView.image = [UIImage imageNamed:@"bg_micro" bundleName:@"Call.bundle" inBundleForClass:[self class]];
            }
        }
            break;
        case StreamStatusTalking:
            if (_enableVoice) {
                _statusView.image = [UIImage imageNamed:@"talking_green" bundleName:@"Call.bundle" inBundleForClass:[self class]];
            }
            break;
...
- (void)setEnableVoice:(BOOL)enableVoice
{
    ...
    if (enableVoice) {
        ...
        _statusView.image = [UIImage imageNamed:@"mute_red" bundleName:@"Call.bundle" inBundleForClass:[self class]];
    }
}
