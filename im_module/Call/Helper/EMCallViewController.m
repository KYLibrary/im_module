...
- (void)_setupCallControllerSubviews
{
    ...
    [self.microphoneButton setImage:[UIImage imageNamed:@"micphone_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    [self.speakerButton setImage:[UIImage imageNamed:@"speaker_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
    ...
    [self.minButton setImage:[UIImage imageNamed:@"minimize_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    [self.hangupButton setImage:[UIImage imageNamed:@"hangup" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
