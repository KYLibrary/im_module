...
- (void)_setupSubviews
{
    ...
    [videoButton setImage:[UIImage imageNamed:@"video_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    [videoButton setImage:[UIImage imageNamed:@"video_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
