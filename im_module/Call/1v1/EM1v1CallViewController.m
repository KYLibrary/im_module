...
- (void)_setup1v1CallControllerSubviews
{
    ...
    for (int i = 25; i < 88; i++) {
        NSString *name = [[NSString alloc] initWithFormat:@"Call.bundle/animate_000%@.png", @(i)];
        [array addObject:[UIImage imageForFileName:name inBundleForClass:[self class]]];
    }
    ...
    [self.minButton setImage:[UIImage imageNamed:@"minimize_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    if (self.callSession.isCaller) {
        ...
        [self.answerButton setImage:[UIImage imageNamed:@"answer" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
