...
- (void)_setupConferenceControllerSubviews
{
    ...
    [inviteButton setImage:[UIImage imageNamed:@"invite_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    [self.switchCameraButton setImage:[UIImage imageNamed:@"switchCamera_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    [self.switchCameraButton setTitleColor:[UIColor grayColor] forState:UIControlStateSelected];
    [self.switchCameraButton setImage:[UIImage imageNamed:@"switchCamera_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
    ...
    [self.switchCameraButton setImage:[UIImage imageNamed:@"switchCamera_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateDisabled];
    ...
    [self.microphoneButton setImage:[UIImage imageNamed:@"micphone_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    [self.microphoneButton setTitleColor:[UIColor grayColor] forState:UIControlStateSelected];
    [self.microphoneButton setImage:[UIImage imageNamed:@"micphone_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
    ...
    [self.microphoneButton setImage:[UIImage imageNamed:@"micphone_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateDisabled];
    ...
    [self.videoButton setImage:[UIImage imageNamed:@"video_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    [self.videoButton setTitleColor:[UIColor whiteColor] forState:UIControlStateSelected];
    [self.videoButton setImage:[UIImage imageNamed:@"video_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
    ...
    [self.videoButton setImage:[UIImage imageNamed:@"video_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateDisabled];
    ...
    [self.speakerButton setImage:[UIImage imageNamed:@"speaker_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    [self.speakerButton setImage:[UIImage imageNamed:@"speaker_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
    ...
    [self.gridButton setImage:[UIImage imageNamed:@"grid_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
