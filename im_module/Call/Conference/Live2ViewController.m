...
- (void)_setupSubviews
{
    ...
    [self.vkbpsButton setImage:[UIImage imageNamed:@"kbps_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    [self.vkbpsButton setImage:[UIImage imageNamed:@"kbps_gray" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateDisabled];
    ...
    [self.roleButton setImage:[UIImage imageNamed:@"role_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateNormal];
    ...
    [self.roleButton setImage:[UIImage imageNamed:@"role_white" bundleName:@"Call.bundle" inBundleForClass:[self class]] forState:UIControlStateSelected];
