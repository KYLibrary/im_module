...
- (void)setIsChecked:(BOOL)isChecked
{
    if (_isChecked != isChecked) {
        ...
        if (isChecked) {
            self.checkView.image = [UIImage imageNamed:@"checked" bundleName:@"Call.bundle" inBundleForClass:[self class]];
        } else {
            self.checkView.image = [UIImage imageNamed:@"uncheck" bundleName:@"Call.bundle" inBundleForClass:[self class]];
        }
    }
}
